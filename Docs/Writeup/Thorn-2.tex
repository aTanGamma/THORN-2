...
;...
                ...
                be fully written back to \lstinline[language={[RISC-V]Assembler}]|a0| 
    ...
    \section{ALU}\label{sec:ALU}
        ...
        \subsection{Logicer}\label{sec:ALU:Logicer}
            ...
            \subsubsection{Setting up the MUX}\label{sec:ALU:Logicer:MUXSetup}
                ...
                The correct truth table is sleected using a 2:4 selector which 
                ...
                The buffers are needed at all both because of the high fanout 
                requirement and because of the forward bias of the Schottkey 
                diodes. 
                With a forward voltage of approx. 0.3 V; this drops the nominal 
